...
class RiwayatTransaksiScreen(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.grid = GridLayout(
            cols=1, spacing=16, padding=[8, 8, 8, 8], size_hint_y=None
        )
    ...
    def tampilkan_riwayat(self):
        ...
        for trx in riwayat:
            pesanan_str = "\n".join(
                [f"{item['name']} x{item['qty']}" for item in trx["items"]]
            )
            ...
            tindakan_box.add_widget(btn_tambah)
